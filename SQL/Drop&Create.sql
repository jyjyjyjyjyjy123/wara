...
-- DROP (기존 객체 모두 제거)
-- ============================================
DROP TRIGGER user_seq_trg;
DROP TRIGGER post_seq_trg;
DROP TRIGGER post_content_seq_trg;
DROP TRIGGER comment_seq_trg;
DROP TRIGGER favorite_seq_trg;
DROP TRIGGER like_seq_trg;
DROP TRIGGER view_log_seq_trg;

DROP SEQUENCE user_seq_seq;
DROP SEQUENCE post_seq_seq;
DROP SEQUENCE post_content_seq_seq;
DROP SEQUENCE comment_seq_seq;
DROP SEQUENCE favorite_seq_seq;
DROP SEQUENCE like_seq_seq;
DROP SEQUENCE view_log_seq_seq;

DROP TABLE POST_VIEW_LOG CASCADE CONSTRAINTS;
DROP TABLE LIKE_TBL CASCADE CONSTRAINTS;
DROP TABLE FAVORITE_TBL CASCADE CONSTRAINTS;
DROP TABLE COMMENT_TBL CASCADE CONSTRAINTS;
DROP TABLE POST_CONTENT_TBL CASCADE CONSTRAINTS;
